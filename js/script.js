...
//        autoplay: true,
    ...
    {
        $('#show_contact_msg').html('<div class=loading>جاري الارسال...</div>');
        var name = $('#name').val();
        var email = $('#email').val();
        ...
        $.ajax(
                {
                    ...
                    success: function (res) {
                        if (res === '1') {
                            $('#show_contact_msg').html('<div class=gen><i class="fa fa-smile-o" aria-hidden="true"></i> شكرا جزيلا، سنتاواصل معاك قريباً</div>');
